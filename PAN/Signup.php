...
<p class="red">       
    ...
    <tr>
    <td>&nbsp;</td>
    <td><h4 align="center"><input type="checkbox" name="Tick" id="Tick">I agree to the PAN Secure <a href="PAN Secure Terms of Service.txt" target="_blank">Terms and Conditions</a> and <a href="Privacy Policy.html" target="_blank">Privacy policy</a></h4></td>
    </tr>
    <tr>
